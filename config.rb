...
%w{yaml oj crack json active_record RMagick addressable/uri paperclip friendly_id geocoder geocoder/models/active_record dnsruby whois}.each{|r| require r}
